            ...
            <section id="dashboard">
                ...
                <div id="status">
                    ...
                    <div class="info-content">
                        ...
                        <a href="reports.php">View More <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Bus" class="info-box status-item">
                        <div class="heading">
                            <h5>Buses</h5>
                ...
                <div id="user">
                    ...
                    <div id="Earning" class="info-box user-item">
                        ...
                        <a href="reports2.php">View More <i class="fas fa-arrow-right"></i></a>
                    </div>
                ...
                <footer>
                    <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Bus Fare Electronic Payment System| Made with &#10084;&#65039; by Moses Ngugi and Muhammad Rabiu
                        </p>
                </footer>
        </div>
    </main>

...
<head>
    ...
    <title>Bus Fare Patment System</title>
    <!-- google fonts -->
...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">BFEPS</a>
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>Electronic Bus Fare Payment System</h1>

            <p class="text-center">Welcome to  BusFare payment System.</p>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                    It All started when the need of automating bus fare AND revolutionaizing the transport sector
                </p>
            </div>
        </section>
        <section id="contact">
